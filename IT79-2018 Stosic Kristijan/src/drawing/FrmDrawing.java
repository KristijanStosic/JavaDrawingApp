...
public class FrmDrawing extends JFrame {
	...
	public FrmDrawing() {
		...
		panelShapes.setBorder(new TitledBorder(new CompoundBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), new BevelBorder(BevelBorder.LOWERED, null, null, null, null)), "Shapes", TitledBorder.CENTER, TitledBorder.TOP, null, Color.BLACK));
		
		JPanel panelActions = new JPanel();
		panelActions.setBorder(new TitledBorder(new CompoundBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), new BevelBorder(BevelBorder.LOWERED, null, null, null, null)), "Actions", TitledBorder.CENTER, TitledBorder.TOP, null, Color.BLACK));
		
		JPanel panelEdgeColor = new JPanel();
		panelEdgeColor.setBorder(new TitledBorder(new CompoundBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), new BevelBorder(BevelBorder.LOWERED, null, null, null, null)), "Edge color", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		
		JPanel panelInnerColor = new JPanel();
		panelInnerColor.setBorder(new TitledBorder(new CompoundBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), new BevelBorder(BevelBorder.LOWERED, null, null, null, null)), "Inner color", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		
		JPanel panelMode = new JPanel();
		panelMode.setBorder(new TitledBorder(new CompoundBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), new BevelBorder(BevelBorder.LOWERED, null, null, null, null)), "Mode", TitledBorder.CENTER, TitledBorder.TOP, null, Color.BLACK));
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGap(4)
									.addComponent(panelInnerColor, GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE))
								.addComponent(panelEdgeColor, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 247, Short.MAX_VALUE)
								.addComponent(panelMode, GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE))))
					.addContainerGap())
		);
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGap(22)
							.addComponent(panelInnerColor, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							.addGap(18)
		...
		gl_panelMode.setHorizontalGroup(
			gl_panelMode.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMode.createSequentialGroup()
					.addGap(64)
					.addGroup(gl_panelMode.createParallelGroup(Alignment.LEADING)
		...
		gl_panelMode.setVerticalGroup(
			gl_panelMode.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panelMode.createSequentialGroup()
					.addGap(15)
					.addComponent(rdbtnDraw)
					.addGap(18)
					.addComponent(rdbtnSelect)
		...
		gl_panelInnerColor.setHorizontalGroup(
			gl_panelInnerColor.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelInnerColor.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelInnerColor.createParallelGroup(Alignment.TRAILING)
						.addComponent(txtInnerColor, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
						.addComponent(btnChooselnnerColor, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))
					.addContainerGap())
		);
		...
		gl_panelEdgeColor.setHorizontalGroup(
			gl_panelEdgeColor.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panelEdgeColor.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelEdgeColor.createParallelGroup(Alignment.TRAILING)
						.addComponent(btnChooseEdgeColor, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
						.addComponent(txtEdgeColor, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))
					.addContainerGap())
		);
		gl_panelEdgeColor.setVerticalGroup(
			gl_panelEdgeColor.createParallelGroup(Alignment.TRAILING)
