...
public class Line extends Shape {
	...
	public double length() {
		return Math.round(startPoint.distance(endPoint.getX(), endPoint.getY()));
	}
	...
	public String toString() {
		return "Line: "+"("+startPoint.getX()+", "+startPoint.getY()+") ("+endPoint.getX()+", "+endPoint.getY()+")" + " Length: " + length();
	}
