...
public class Donut extends Circle {
	...
	public void draw(Graphics g) {
		/*
		 * super.draw(g); g.setColor(getColor()); g.drawOval(getCenter().getX() -
		 * this.innerRadius, getCenter().getY() - this.innerRadius, this.innerRadius *
		 * 2, this.innerRadius * 2);
		 */
	...
	public double area() {
		return Math.round(super.area() - innerRadius * innerRadius * Math.PI);
	}
	...
	public String toString() {
		return "Donut: (" + getCenter().getX() + ", " + getCenter().getY() + "), " + "Radius=" + radius
				+ ", Inner Radius=" + this.innerRadius + " Area: " + area();
	}
