...
public class DlgRectangleModify extends JDialog {
	...
	private JTextField txtEdgeColorRec;
	private JTextField txtInnerColorRec;
	...
	public DlgRectangleModify() {
		...
		txtEdgeColorRec = new JTextField();
		txtEdgeColorRec.setEditable(false);
		txtEdgeColorRec.setColumns(10);
		
		txtInnerColorRec = new JTextField();
		txtInnerColorRec.setEditable(false);
		txtInnerColorRec.setColumns(10);
		...
		gl_pnlCenter.setHorizontalGroup(
			gl_pnlCenter.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_pnlCenter.createSequentialGroup()
					...
					.addGap(47)
					.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING)
						.addComponent(txtInnerColorRec)
						.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING, false)
							.addComponent(txtEdgeColorRec, GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
		...
		gl_pnlCenter.setVerticalGroup(
			gl_pnlCenter.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlCenter.createSequentialGroup()
					...
					.addGap(28)
					.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING)
						.addComponent(txtEdgeColorRec)
						.addComponent(btnChooseEdgeColor))
					.addPreferredGap(ComponentPlacement.RELATED, 27, Short.MAX_VALUE)
					.addGroup(gl_pnlCenter.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnChooseInnerColor)
						.addComponent(txtInnerColorRec, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE))
					.addGap(23))
		);
